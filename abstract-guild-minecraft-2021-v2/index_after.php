...
<head>
	...
	<meta property="og:description" content="A modded minecraft server for the Abstract guild." />
...
<body>	
	<div class="wrapper">
		...
		<img src='./img/cavs-and-cliffs-logo.png' id='logo2'>
		
		<div class='countdown-wrapper'>
			<h1 id='event-name'>SEED:</h1>
			<p id="countdown">-3009625944982219226</p>
			
			<h1 id='event-name'>ADDRESS:</h1>
			<p id="countdown">mc.abstractguild.org</p>
		</div>
		...
		<table>
			<tr>
				...
				<td>
					...
					<div id="instruction">
						<p id='tldr'><b>[TL;DR]</b> - Launch day. We all log on nat the same time and begin the 1.18 season.</p>
...
var countDownDate = new Date("Dec 1, 2021 21:00:00").getTime();
...
var x = setInterval(function() {
  ...
  // If the count down is over, write some text 
	//if (distance < 0) {
		//clearInterval(x);
		//document.getElementById("event-name").innerHTML = "SEED:";
		//document.getElementById("countdown").innerHTML = "-3009625944982219226";
		//}
	//}, 1000);
</script>
</body>
